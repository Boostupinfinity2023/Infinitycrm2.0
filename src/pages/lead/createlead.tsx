...
export default function App() {
  ...
  return (
    <>
      <Button onPress={onOpen} size="sm"  className="text-black" > <PlusIcon /> New Lead</Button>
      <Modal 
          size='3xl' 
          isOpen={isOpen} 
      ...
      >
          ...
          {(onClose) => (
              <>
              <form>
                <ModalHeader className="flex flex-col gap-1">Garnete A New Lead</ModalHeader>
                <ModalBody>
                <div className="flex w-full flex-col">
                  <Tabs aria-label="Options">
                    <Tab key="photos" title="Visa lead">
                      <form>
                    ...
                    <Tab key="music" title="Study Visa Lead">
                      <Card>
                        <CardBody>
                    ...
                    <Tab key="videos" title="Visitor Visa Lead">
                      <Card>
                        <CardBody>
