...
const Analytics = () => {
    ...
    const handleClose = () => {
        setIsOpen(false);
        setmodalhide(false); // Close the modal and set Modalhide to false
    };
    ...
    const salesByCategory: any = {
        ...
        options: {
            ...
            labels: ['Approved leave', 'Unapproved', 'Pending'],
            states: {
                hover: {
                    filter: {
                        type: 'none',
                ...
                <>
                    <div className="pt-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                            <Card>
                                <CardBody className="flex flex-col items-center justify-center p-3 gap-4">
                                    <CustomIcon1 />
                        ...
                        <Card className="col-span-2">
                            <CardBody className="p-4">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <Link to="/staff/viewAnnouncement" className="text-blue-500 text-sm">View All</Link>
                                </div>

                                <Table hideHeader aria-label="Example static collection table" removeWrapper className='staff-announcement table6'>
                                    <TableHeader>
