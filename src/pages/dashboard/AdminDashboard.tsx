...
const Analytics = () => {
    ...
    const salesByCategory: any = {
        series: [AgentData?.Total_Leave_approved || 0, AgentData?.Total_Leave_notapproved || 0, AgentData?.Total_Leave_Pending || 0],
        options: {
            chart: {
                type: 'donut',
                height: 260,
    ...
    return (
        <>
            ...
            <div>
                <div className="flex flex-col lg:flex-row md:flex-row justify-between items-start lg:items-center set_width">
                    ...
                    <>
                        <div className="pt-5">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
                                <Card>
                                    <NavLink to={'/admin/staff/student/application'}>
                                ...
                                <Card>
                                    <NavLink to={'/admin/staff/student/application#lead'}>
                                        <CardBody className="flex flex-col items-center justify-center p-4 gap-4">
                                            <CustomIcon2 />
                                ...
                                <Card>
                                    <NavLink to={'/admin/hrm/company/user'}>
                                        <CardBody className="flex flex-col items-center justify-center p-4 gap-4">
                                            <CustomIcon3 />
                                ...
                                <Card>
                                    <NavLink to={'/admin/university/add'}>
                                        <CardBody className="flex flex-col items-center justify-center p-4 gap-4">
                                            <CustomIcon5 />
                            ...
                            <Card className="col-span-2">
                                <CardBody className="p-4">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <Link to="/admin/announcement" className="text-blue-500 text-sm">View All</Link>
                                    </div>

                                    <Table hideHeader aria-label="Example static collection table" removeWrapper className='table6'>
                                        <TableHeader>
                                                    ...
                                                    <TableRow key={i + 1}>
                                                        ...
                                                        <TableCell data-column="Status">
                                                            <div className="flex items-center space-x-2">
                                                                <Link to="/admin/announcement" className="text-blue-500">View Announcement</Link>
