...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setGooglesearch(state, { payload }) {
            state.googlesearch = payload;
        }
    },
});

export const { setGooglesearch, toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle } = themeConfigSlice.actions;
