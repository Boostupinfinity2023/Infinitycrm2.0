                ...
                <div className="flex justify-between flex-wrap px-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <select id="invoiceLabel" name="inv-label" className="form-select lg:w-[250px] w-2/3" defaultValue="" disabled>
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <input id="email" type="email" name="due-date" placeholder="Enter Email" className="form-input lg:w-[250px] w-2/3" />
                        </div>
                    ...
                    <div className="lg:w-1/2 w-full lg:max-w-fit">
                        ...
                        <div className="flex items-center mt-4">
                                <label htmlFor="country" className="flex-1 ltr:mr-2 rtl:ml-2 mb-0">
                                    Country
                                </label>
                                <select id="country" name="country" className="form-input lg:w-[250px] w-2/3">
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <input id="invoiceLabel" type="text" name="inv-label" className="form-input lg:w-[250px] w-2/3" placeholder="Total Commision" />
                        </div>
                        <div className="flex items-center mt-4">
                            <label htmlFor="dueDate" className="flex-1 ltr:mr-2 rtl:ml-2 mb-0">
                                Status
                            </label>
                            <input id="invoiceLabel" type="text" name="inv-label" className="form-input lg:w-[250px] w-2/3" placeholder="Status" />
                        </div>
                    </div>
                </div>
