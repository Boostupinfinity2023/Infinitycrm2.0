            ...
            >
                {ApplicationTotal.map((Applicat: any, index: any) => (
                    <TableRow key={index}>
                        ...
                        <TableCell><div dangerouslySetInnerHTML={{ __html: Applicat.NOTES }} /></TableCell>
                        <TableCell><div dangerouslySetInnerHTML={{ __html: Applicat.COMMENT }} /></TableCell>
                        <TableCell>  {formatDateTime(Applicat.ACTION_DATE)}</TableCell>
                    </TableRow>
                ))}
            </TableBody>
        </Table>
