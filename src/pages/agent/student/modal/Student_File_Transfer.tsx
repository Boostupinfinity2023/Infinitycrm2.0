        ...
        <>
            ...
            >
                <form onSubmit={handletransferfile}>
                    {array.length > 1 && (
                        <>
                            <span className="mb-2 text-green-500">Note: Select Primary Country * </span>
                    ...
                    <div className="note flex mt-2">
                        <input type="checkbox" name="FileTransfer[checkBox]" required />
                        <span className="ml-2 font-Poppins">Confirm file transfer</span>
                    </div>

                    {/* Handler Button  */}
                    <div className="bg-bule">
                        <Space className="FormButtonSetupCss">
                            <button className="btn btn-primary" type={(loader) ? 'button' : 'submit'} disabled={loader}>
