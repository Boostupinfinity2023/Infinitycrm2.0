    ...
    const menu = (event: any) => (
        <Menu>
            <Menu.Item key="1">
                ...
                <NavLink to={`/admin/client/view/${event.ID}/${event.application_id}/${event.CLIENT_ID}/staff`} className="">
    ...
    const columns: TableColumnsType<DataType> = [

        {
            ...
            render: (event, fullInfo: any) => (
                <NavLink to={`/admin/client/view/${fullInfo.ID}/${fullInfo.application_id}/${fullInfo.CLIENT_ID}/staff`} className="text-color-blue" data-column="Application ID">
        ...
        },
        {
            ...
            width: 250,
            render: (event, fullInfo: any) => (
                <span data-column="Responsive Details">
                <Tooltip color='#006ED9' title={
                    JSON.parse(fullInfo.RESPONSIVE_INFO).RESPONSIVE_EMAIL
                } overlayStyle={{ maxWidth: '100%' }}>
                    <span>{JSON.parse(fullInfo.RESPONSIVE_INFO).RESPONSIVE_NAME}</span>
                </Tooltip>
                </span>
        ...
        },
        {
            ...
            width: 250,
            render: (event, fullInfo: any) => (
                <span data-column="Agent Detail">
                <Tooltip color='#006ED9' title={
                    JSON.parse(fullInfo.CREATE_INFO).CREATE_EMAIL
                } overlayStyle={{ maxWidth: '100%' }}>
                    <span>{JSON.parse(fullInfo.CREATE_INFO).CREATE_NAME}</span>
                </Tooltip>
                </span>
        ...
        },
        {
            ...
            width: 250,
            render: (event, fullInfo: any) => (
                <span data-column="Client Detail">
                <Tooltip color='#006ED9' title={
                    <>
                        <p>{fullInfo.EMAIL}</p>
                        <p>{fullInfo.PHONE_NUMBER}</p>
                    </>
...

        {
            ...
            width: 450,
            render: (event, fullInfo: any) => (
                <span data-column="Application Status">
                <Select
                    items={Dealstatus}
        ...
        <>
            ...
            <div>
                <div className='flex justify-end'>
                    <button
                        className="btn modal-btn-custom crtbtnup adminmobbtns"
                        onClick={() => {
                    ...
                    <div className="grid gap-11 set_margin_bottom mt-5">
                        <div className="col-span-3">
                            <div className="w-full flex flex-col gap-4">
                                <h3 className="h3_tag text-2xl adminsidedown"> Application Filter </h3>
                                <div className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                                    <Input size={'md'} type="text" placeholder="Application ID" onChange={handleKeyDown} />
                                    <Input size={'md'} type="text" placeholder="Client Passport No." onKeyDown={handleKeyDownPassport} />
